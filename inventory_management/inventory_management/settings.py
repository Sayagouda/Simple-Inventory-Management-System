...
SECRET_KEY = 'v78d38%g++xww=hn$zed(i4i)ui-e0@*_#h@&y@a@%5b5-%+79'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # You can restrict this to specific hosts in production
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Blooprint',                # Replace with your database name
